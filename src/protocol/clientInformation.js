...
// Serverbound Client Information. Used during Configuration (id 0x00).
// The exact same field layout is also used for the Play-state version of
// this packet (id 0x0e in protocol 775), so the packet id is configurable.
class ClientInformation {
  constructor(packetId = 0x00) {
    ...
    w.writeByte(0x7f); // displayed skin parts (all enabled)
